...
var TableData = function ()
{
	...
	// Dom
	if(TableDataObject) DatabaseMainObject.ContantBlock.removeChild(TableDataObject.TableDataMainBlock);	
	C(this.TableDataMainBlock, 'In', [ C('div', {'id':'ListPageOffsetTop'}), C(C('div', {'id':'ListData'},{'margin':'0px'}), 'In', this.list) ])
	C(DatabaseMainObject.ContantBlock, 'In', this.TableDataMainBlock);
